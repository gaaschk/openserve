...
@Entity
public class DailyStockQuote extends OpenServDomainObject{
	private static final long serialVersionUID = 5200896181147108602L;
	private Long dailyStockQuoteID;
	...
	public Long getDailyStockQuoteID() {
		return dailyStockQuoteID;
	}
	public void setDailyStockQuoteID(Long dailyStockQuoteID) {
		this.dailyStockQuoteID = dailyStockQuoteID;
	}
	...
	@Override
	public Long getID() {
		return this.getDailyStockQuoteID();
	}
}
