...
@Repository
public class DueDiligenceScheduleRepository extends BaseRepository<DueDiligenceSchedule, Serializable>{
	@Resource
...
@Repository
interface DueDiligenceScheduleSpringRepository extends BaseSpringRepository<DueDiligenceSchedule, Serializable>{
