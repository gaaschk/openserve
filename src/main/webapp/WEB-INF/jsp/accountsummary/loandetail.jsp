...
.menu li a{float:left; padding-left:15px; display:block; color:rgb(255,255,255); text-decoration:none; font:12px Verdana, Arial, Helvetica, sans-serif; cursor:pointer; background:url("${imagesUrl}/main_bg.png") 0px -30px no-repeat;}
...
.menu li a.active, .menu li a.active:hover{line-height:30px; font:12px Verdana, Arial, Helvetica, sans-serif; background:url("${imagesUrl}/main_bg.png") 0px -90px no-repeat; color:rgb(255,255,255);}
.menu li a.active span, .menu li a.active:hover span{background:url("${imagesUrl}/main_bg.png") 100% -90px no-repeat;}
</style>

<script type="text/javascript"> 
window.addEvent('domready', function() { initTabs(); }); 

function initTabs() { $ES('a','tabMenu').each(function(el) { 
...
<div id="tabContainer">
  <div id="tabMenu"> 
	<ul class="menu">
  	  <li><a href="#" class="active"><span>Loan Detail</span></a></li>
